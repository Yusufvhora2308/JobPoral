...
<div class="mt-2">
    <small class="text-black fw-semibold d-block mb-1 fs-6 fw-bold">
        Missing Skills:
    </small>

    <div class="d-flex flex-wrap">
        @foreach(explode(',', $app->missing_skills) as $skill)
            <span class="badge rounded-pill bg-danger text-white border border-danger px-3 py-2 me-2 mb-2 fw-bold">
                {{ trim($skill) }}
            </span>
        @endforeach
    </div>
